...
@Builder
@Schema(description = "1:1 매칭 요청자 프로필")
public record OneOnOneRequesterProfileDto(
    ...
    public static OneOnOneRequesterProfileDto from(User user) {
        return new OneOnOneRequesterProfileDto(
                user.getId(),
                user.getNickname(),
                user.getAge(),
                user.getGender(),
