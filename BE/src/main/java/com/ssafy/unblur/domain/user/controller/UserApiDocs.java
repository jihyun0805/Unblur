...
public interface UserApiDocs {
    ...
    @Operation(summary = "연애 성향 유형 수정", description = "현재 로그인된 사용자의 Love DNA 정보를 수정합니다.")
    @ApiResponse(responseCode = "200", description = "Love DNA 수정 성공", content = @Content(schema = @Schema(implementation = SwaggerResponses.ProfileResponse.class)))
    @ApiResponse(
            responseCode = "401",
            description = "인증되지 않은 사용자",
            content = @Content(
    ...
    ResponseEntity<BaseResponse<UserProfileResponseDto>> updateLoveDna(LoveDnaUpdateRequest dto);
