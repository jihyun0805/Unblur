...
import { confirmPasswordResetCode, resetPassword } from "@/lib/api/auth"
...
export function EmailVerificationModal({ open, onOpenChange, email, onComplete }: EmailVerificationModalProps) {
