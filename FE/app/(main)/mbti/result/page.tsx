...
const getImagePath = (code: string) => `/mbti/results/${code}.PNG`
...
const RESULT_CONTENT: Record<
  string,
  {
    ...
    feature: string
    caution: string
    bestMatch: { code: string; name: string }
...
> = {
  ...
  ETSA: {
    ...
    bestMatch: { code: "ITPD", name: "신중한 분석가" },
    worstMatch: {
      code: "IFPD",
      name: "신중한 낭만파",
...
export default function MbtiResultPage() {
  ...
  const modalTitle = listType === "best" ? "천생연분 온라인 목록" : "주의 조합 온라인 목록"
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-xl border bg-card/90 backdrop-blur shadow-lg p-3 text-center">
              <div className="text-sm font-semibold mb-2">천생연분</div>
              <img
